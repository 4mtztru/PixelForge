...
public class Grupo {
     ...
     * @return true si el usuario se agregó correctamente, false si ya estaba en el
     *         grupo
    ...
    public boolean addUsuario(Usuario usuario) {
        ...
        if (usuarios.contains(usuario)) {
            // Checo si el usuario está en el grupo por que no se puede agregar un usuario
            // dos veces
            return false;
        }
     ...
     * 
     * @param usuario el usuario que deseo agregar al grupo
     * @return true si el usuario se quitó correctamente, false si no estaba en el
     *         grupo
     * @throws IllegalArgumentException si el usuario es nulo
     */
